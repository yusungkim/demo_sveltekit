...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies_esbuild_linux_64: string;
	...
	export const npm_package_devDependencies__steeze_ui_svelte_icon: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		TERM: string;
		npm_package_dependencies_esbuild_linux_64: string;
		...
		PWD: string;
		npm_execpath: string;
		npm_package_devDependencies__steeze_ui_svelte_icon: string;
